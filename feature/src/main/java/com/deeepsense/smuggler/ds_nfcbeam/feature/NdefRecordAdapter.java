    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(record instanceof AndroidApplicationRecord) {
            ...
            if(androidApplicationRecord.hasPackageName()) {
                TextView textView = view.findViewById(R.id.androidApplicationPackageNameValue);
            ...
            if(externalType.hasDomain()) {
                TextView textView = view.findViewById(R.id.domainValue);
                textView.setText(externalType.getDomain());
            }
            if(externalType.hasType()) {
                TextView textView = view.findViewById(R.id.typeValue);
                textView.setText(externalType.getType());
            }

            if(externalType.hasData()) {
                TextView textView = view.findViewById(R.id.dataValue);
            ...
            if(smartPosterRecord.hasTitle()) {
                ...
                if(title.hasText()) {
                    TextView textView = view.findViewById(R.id.smartPosterTitleValue);
                    textView.setText(title.getText());
                }
                if(title.hasLocale()) {
                    TextView textView = view.findViewById(R.id.smartPosterTitleDescriptor);
            ...
            if(smartPosterRecord.hasUri()) {
                TextView textView = view.findViewById(R.id.smartPosterURIValue);
            ...
            if(smartPosterRecord.hasAction()) {
                TextView textView = view.findViewById(R.id.smartPosterActionValue);
            ...
            if(textRecord.hasEncoding()) {
                TextView textView = view.findViewById(R.id.textEncodingValue);
                textView.setText(textRecord.getEncoding().displayName());
            }
            if(textRecord.hasText()) {
                TextView textView = view.findViewById(R.id.textMessageValue);
                textView.setText(textRecord.getText());
            }
            if(textRecord.hasLocale()) {
                TextView textView = view.findViewById(R.id.textLocaleValue);
            ...
            if(actionRecord.hasAction()) {
                ...
                TextView textView = view.findViewById(R.id.actionActionValue);
            ...
            if(mimeMediaRecord.hasMimeType()) {
                TextView textView = view.findViewById(R.id.mimemediaMimetypeValue);
                textView.setText(mimeMediaRecord.getMimeType());
            }

            TextView textView = view.findViewById(R.id.mimemediaSizeValue);
            ...
            if(alternativeCarrierRecord.hasCarrierPowerState()) {
                TextView value = view.findViewById(R.id.alternativeCarrierCarrierPowerStateValue);
                value.setText(alternativeCarrierRecord.getCarrierPowerState().toString());
            }

            if(alternativeCarrierRecord.hasCarrierDataReference()) {
                TextView value = view.findViewById(R.id.alternativeCarrierCarrierDataReferenceValue);
                value.setText(alternativeCarrierRecord.getCarrierDataReference());
            }

            TextView value = view.findViewById(R.id.alternativeCarrierAuxiliaryDataReferencesValue);
            ...
            if(handoverCarrierRecord.hasCarrierTypeFormat()) {
                TextView value = view.findViewById(R.id.handoverCarrierCarrierTypeFormatValue);
                value.setText(handoverCarrierRecord.getCarrierTypeFormat().toString());
            }

            if(handoverCarrierRecord.hasCarrierType()) {
                TextView value = view.findViewById(R.id.handoverCarrierCarrierTypeValue);
            ...
            TextView value = view.findViewById(R.id.handoverCarrierCarrierDataValue);
            ...
            TextView value = view.findViewById(R.id.handoverSelectMajorVersionValue);
            value.setText(Byte.toString(handoverSelectRecord.getMajorVersion()));

            value = view.findViewById(R.id.handoverSelectMinorVersionValue);
            value.setText(Byte.toString(handoverSelectRecord.getMinorVersion()));

            value = view.findViewById(R.id.handoverSelectAlternativeCarriersValue);
            value.setText(Integer.toString(handoverSelectRecord.getAlternativeCarriers().size()));

            if(handoverSelectRecord.hasError()) {
                value = view.findViewById(R.id.handoverSelectErrorValue);
            ...
            if(uriRecord.hasUri()) {
                TextView textView = view.findViewById(R.id.uriValue);
            ...
            TextView configurationByteView = view.findViewById(R.id.genericControlConfigurationByteValue);
            ...
            if(genericControlRecord.hasTarget()) {
                ...
                if(target.hasTargetIdentifier()) {
                    TextView textView = view.findViewById(R.id.genericControlTargetValue);
            ...
            if(genericControlRecord.hasAction()) {
                TextView textView = view.findViewById(R.id.genericControlActionValue);
            ...
            if(genericControlRecord.hasData()) {
                ...
                TextView textView = view.findViewById(R.id.genericControlDataValue);
